    ...
    <div class="card-header" data-background-color="green-dark">
        ...
        <div class="card-content table-responsive">
            ...
            <div class="card-content table-responsive">
                ...
                ?>
                <form accept-charset="UTF-8" role="form" action="upfoto.php" enctype="multipart/form-data" method="POST"
                      name="datos">
                    <fieldset>
                        <div class="alert alert-warning" role="alert">
                            <h4>"Estimado participante recuerde Guardar su voucher con el nombre de su DNI para usarlo
                                como identificador de la persona que envía el pago."</h4>
                        </div>
                        <table width="100%">
                            <tr>
                                <td width="50%">
                                    ...
                                    <div class="form-group is-empty">
                                        <b>Nombres del Beneficiario:</b><input class="form-control" name="datouno"
                                                                               value="<?php echo $beneficiario->nombres; ?>"
                                                                               type="text" disabled=''>
                                        <span class="material-input"></span>
                                    </div>

                                    <div class="form-group is-empty">
                                        <b>N&uacutemero de Cuenta del Beneficiario:</b><input class="form-control"
                                                                                              name="datouno"
                                                                                              value="<?php echo $n_cuenta; ?>"
                                                                                              type="text" disabled=''>
                                        <span class="material-input"></span>
                                    </div>

                                    <div class="form-group is-empty">
                                        <b>Entidad Financiera del Beneficiario:</b><input class="form-control"
                                                                                          name="datouno"
                                    ...
                                    <div class="form-group is-empty">
                                        <b>Celular del Beneficiario:</b><input class="form-control" name="datouno"
                                                                               value="<?php echo $beneficiario->celular; ?>"
                                                                               type="text" disabled=''>
                                        <span class="material-input"></span>
                                    </div>
...
//                $('#imgupload').attr('src', e.target.result);
                ...
                document.getElementById('imgupload').style.backgroundImage =  urlString;
            }
