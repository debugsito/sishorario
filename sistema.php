...
<a href="#" class="btn btn-warning" data-toggle="modal" <?php if(!empty($diff_brindar->invert) or $diff_brindar->invert == 1){ ?>  data-target="#ModalRegistroRegional"  <?php }else{ ?> disable <?php }; ?> ><i class="fa fa-child" aria-hidden="true"></i>  Brindar Ayuda</a>	
<?php }else{ ?>
<a href="#" class="btn btn-warning" data-toggle="modal"   data-target="#ModalRegistroRegional"  <i class="fa fa-child" aria-hidden="true"></i>  Brindar Ayuda</a>
<?php } ?>
<br><br><br><br>
...
<?php $bridas_ayudas = AyudaData::getAllAyudaUltimo($idd);
    ...
    <?php foreach($bridas_ayudas as $brida_ayuda):?>
...
<table class="timecard" style="width:100%">
    <tr>    
		<td><center><b>ELIMINAR AYUDA :</b></center></td>
		<td><center><?php echo "<a class='btn btn-danger btn-sm' href='funciones/php/eliminar.php?id=".$id."'><i class='material-icons'>delete_forever</i></a>";?> </center></td>
	</tr>
  
  
    <tr>
		<td><center><b>MONTO BRINDADO : </b></center></td>
		<td><center><b>S/. <?php echo $monto; ?></b></center></td>
	</tr>
	<tr>
		<td><center><b>FECHA :</b></center></td>
		<td><center><b><?php echo $fecha; ?></b></center></td>
	</tr>
...
<center>
    <div class="contador" data-until="<?php date_default_timezone_set('America/Lima'); echo strtotime($fini);?>" data-done="¡No brindó ayuda!" data-respond>
       ...
       <div class="conta"></div>
        ...
        <div class="conta"></div>
        </div> <font size="3" color="#29B6F6"><b>días</b></font>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------->
 <br><br>
		...
		<div class="card-content table-responsive">
<a href="#" class="btn btn-info" data-toggle="modal" data-target="#ModalRegistroAyuda" id="btnRegistrarAyuda" onClick="this.disabled=true"><i class="fa fa-handshake-o" aria-hidden="true" ></i> Solicitar Ayuda</a>			
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
 ...
 <div class="modal-content" style="overflow : auto;">
        <div class="modal-header" style="height: 800px;">
            ...
            <h4 class="modal-title"><i class="fa fa-money" aria-hidden="true"></i><b> MoneyWork | Brindar Ayuda</b></h4><hr />
		      <div class="card-content">

<div class="alert alert-warning" role="alert">
<h4><i class="fa fa-bell" aria-hidden="true"> "Estimado participante recuerde que en su próxima ayuda brindará como monto mínimo la ayuda abonada en su anterior participación . " </i></h4>

<h4><i class="fa fa-bell" aria-hidden="true"> "Estimado participante , recuerde que solo puede brindar ayuda en múltiplos de 10 . Por ejemplo : (S/.50.00, S/.60.00, S/.70.00, S/.80.00, ...) ." </i></h4>
</div> 

	 <form action="RegistrarAyuda.php" method="POST" name="form1" onsubmit="return validacion()">

                 <b> Monto a dar Ayuda : </b> <input name="montos" type="number"   placeholder=" S/." required="" id="montos" > 
 
                 <input name="id_usuario" type="hidden" required=""  value="<?php echo $idd; ?>" placeholder=" "> 
...
<div id="contenido_pestanas" class="table-responsive" align="center">
    <ul class="nav nav-tabs">
        <center><li><a href="#contenedor" title="Ayudas"><font color="white">&because; AYUDAS &because;</font></a></li></center>
        <center><li><a href="#contenedor2" title="Bonos"><font color="white">&because; BONOS &because;</font></a></li></center>
...
<div align="center" >
 <input type="radio" style="margin-top: 300px;" name="condicion" value="1" required=""><b>  He leído y acepto las </b><a data-toggle="modal" href="#myModal"><b>políticas y procedimientos .</b></a>

 </div>	
 
 <button class="btn btn-warning" type="submit" style=" margin-top: 18px;" ><i class="fa fa-child"></i><b> Brindar Ayuda</b></button>	
    ...
    <div class="modal-dialog">
	  ...
	  <h5 class="modal-title"><b>POLÍTICA | MONEYWORK &copy;</b></h5>
        <div class="modal-body">
            <font color="black"><center><b>"
MONEYWORK es una comunidad de ayuda mutua , no somos una empresa de inversiones , no somos una red de mercadeo , no brindamos ningún servicio ni tampoco vendemos productos .
MONEYWORK tiene como finalidad ayudar económicamente a quienes lo requieran con el propósito de dar para para recibir . Al tratarse de una donación voluntaria , MONEYWORK no 
garantiza retorno alguno, ya que es una donación . MONEYWORK es una comunidad conocida como CROWDFUNDING. Por favor realice la donación con el monto que crea conveniente y que 
no pueda afectar su economía ."</b><center></font>
			</div>
			</div>
			 </div>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-money" aria-hidden="true"></i><b> MoneyWork | Solicitar Ayuda</b></h4>
			
		      <div class="card-content">

		<form action="RecibirAyuda.php" method="POST">
 
     <center><div class="tables" align="center">
				<?php
