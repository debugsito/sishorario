...
<th><center>Afiliado</center></th>
<th><center>Ayuda Brindada</center></th>
<th><center>Porcentaje</center></th>
<th><center>Ganacia</center></th>
...
////echo $user->idUsuario; echo '-----'. $fecha2;     
  ...
  //echo $usuario->idUsuario.'Patrocinador';
    ...
    if(count($ayudas)>0){ 
      ...
      <tr>  
        <td><center><?php echo $user->nombres; ?></center></td>  
        <td><center>S/. <?php echo $ayuda->monto; ?></center></td>  
        <td><center> 10% </center> </td>
        <td><center><b>S/. <?php echo ($ayuda->monto*10)/100 ?> </b></center> </td>  
        ...
        <?php }else{ ?>
        <a class='btn btn-danger btn-sm' style="background-color: black;">Rechazado</a>
        <?php }; ?>
     ...
     <?php } ?>
      ...
      ?>
                   ...
                   <tr>  
                    <td><center><?php echo $user1->nombres; ?></center></td>  
                    <td><center>S/. <?php echo $ayuda1->monto; ?></center></td>  
                    <td><center> 5% </center> </td>
                    <td><center><b> S/. <?php echo ($ayuda1->monto*5)/100 ?> </b></center> </td>  
                    <td><center><?php echo $ayuda1->fecha; ?></center></td>  
                    <td><center>
      ...
      ?>
        ...
        ?>
              ...
              foreach($ayudas2 as $ayuda2){ ?>
                     ...
                     <tr>  
                      <td><center><?php echo $user2->nombres; ?></center></td>  
                      <td><center>S/. <?php echo $ayuda2->monto; ?></center></td>  
                      <td><center> 2.5% </center> </td>
                      <td><center><b> S/. <?php echo ($ayuda2->monto*2.5)/100 ?> </b></center> </td>  
                      <td><center><?php echo $ayuda2->fecha; ?></center></td>  
                      <td><center>
        ...
        <?php }; ?>
          ...
          ?>
                      ...
                      foreach($ayudas3 as $ayuda3){ ?>
                             ...
                             <tr>  
                              <td><center><?php echo $user3->nombres; ?></center></td>  
                              <td><center>S/. <?php echo $ayuda3->monto; ?></center></td>  
                              <td><center> 1% </center> </td>
                              <td><center><b> S/. <?php echo ($ayuda3->monto*1)/100 ?> </b></center> </td>  
                              <td><center><?php echo $ayuda3->fecha; ?></center></td>  
                              <td><center>
        ...
        <?php }; ?>
                ...
                ?>
                                ...
                                foreach($ayudas3 as $ayuda4){ ?>
                                       <tr>  
                                        <td><center><?php echo $user4->nombres; ?></center></td>  
                                        <td><center>S/. <?php echo $ayuda4->monto; ?></center></td>  
                                        <td><center> 0.5% </center> </td>
                                        <td><center><b> S/. <?php echo ($ayuda4->monto*0.5)/100 ?> </b></center> </td>  
                                        <td><center><?php echo $ayuda4->fecha; ?></center></td>  
                                        <td><center>
