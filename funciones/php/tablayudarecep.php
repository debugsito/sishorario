        ...
        if(count($ayudas)>0){
            ...
            foreach($ayudas as $ayuda){
                ...
                <tr <?php if($ayuda->validar==1){ ?> style="background-color: #D4E157;" <?php } ?> >
                    <td> </td>
                    <?php
                    //  echo "Id_ayuda:".$ayuda->id.' => '.$ayuda->getUsuario()->idUsuario.' => '.$ayuda->getUsuario()->id_patrocinador.'<br>';
                    $patrocinador = UsuarioData::getByPatrocinador($ayuda->getUsuario()->id_patrocinador);
                    ...
                    <td><a href="#" data-toggle="popover" title="<?php echo 'Celular: ' . $ayuda->getUsuario()->celular; ?>"
                           data-content="<?php if ($ayuda->getUsuario2()->id_patrocinador != 0) {
                               ...
                               echo 'Cel Patrocinador: ' . $patrocinador->celular;
                           } ?>"
                        >
